...
class ArmourChest : public ItemArmour {
	public:
	ArmourChest() : ItemArmour("Armour Chestplate", "CHEST_ARMOUR", "Moulded from the toughest metals found on earth, this will protect the wearer from a lot of things.", 'U');
    {
